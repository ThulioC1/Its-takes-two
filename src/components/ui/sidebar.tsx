  ...
  (
    ...
    return (
       <div
        ref={ref}
        className={cn(
          "hidden md:flex flex-col h-screen w-[var(--sidebar-width)] sticky top-0 transition-[width] duration-300 ease-in-out",
...
>(
  (
    ...
    if (typeof tooltip === "string" && state === "expanded" && !isMobile) {
        return button;
    }
